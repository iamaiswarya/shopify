...
class Verifyotp extends StatelessWidget {
  ...
  onCompleted: (pin) {},
           ...
           ListTile(
            title: Row(
              children: <Widget>[
                Expanded(child: FlatButton(onPressed: () {},child: Text("Change Number"),textColor: Colors.blue,)),
                Expanded(child: FlatButton(onPressed: () {},child: Text("Resend OTP"),textColor: Colors.blue,)),
              ],
            ),
          ),        
              SizedBox(height: 40),
