...
class UploadPANDocument extends StatefulWidget {
  @override
  _UploadPANDocumentState createState() => _UploadPANDocumentState();
}

class _UploadPANDocumentState extends State<UploadPANDocument> {
                 ...
                 child: Container(
                   ...
                   child: Column(
                     ...
                     children: [
                       ...
                       Padding(
                         padding: const EdgeInsets.all(8.0),
                         child: Text('Tips on how to click right photos',
                         style: TextStyle(fontSize: 12,color: Colors.grey[600]),),
                       ),
                       Image(
                             height: 200,
                             width: 400,
                             image: AssetImage("assets/account/CorrectImage1.jpg"),
                 ...
                 padding: const EdgeInsets.all(15.0),
                    ...
                    decoration: BoxDecoration(
                         ...
                         Image(
                                     height: 40,
                                     width: 40,
                                     image: AssetImage("assets/account/cam.jpg"),

                                     ),
                   Padding(
                     padding: const EdgeInsets.all(8.0),
                     child: Text('Upload high resolustion photo for better',
                                         style: TextStyle(fontSize: 12,color: Colors.grey[600]),),
                   ),
                        
                                  Text('approval chances.',
                                          style: TextStyle(fontSize: 12,color: Colors.grey[600]),),
