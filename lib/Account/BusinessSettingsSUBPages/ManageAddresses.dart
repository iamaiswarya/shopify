    ...
    bottomNavigationBar: BottomAppBar(
     child:Padding(
       ...
       child: RaisedButton(
                        ...
                        onPressed:(){
                          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => AddNewAddress()));
                        },
                        child: Text(
                          'Add Address',
            ...
            //   children: [
                Container(
                  ...
                  child: GestureDetector (
                    onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => UpdateAddress()));    
                    },
                                      child: Row(
