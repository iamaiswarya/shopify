             ...
             Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('Submit the relevant GST Certificate against the address',
                    style: TextStyle(
                 ...
                 child: SingleChildScrollView(
                         ...
                         children: [
                          ...
                          padding: const EdgeInsets.fromLTRB(15,5,15,0),
                             child: Text("GST REG 06 (Registration Certificate)",
                                 ...
                                 child: GestureDetector(
                                     onTap: (){
                                       Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Sample(
                                         image: 'assets/account/Registration_certificate.png',
                                       )));
                                   },
                                                      child: Image(
                      height: 140,
                      width: 100,
                      image: AssetImage("assets/account/Registration_certificate.png"),
                               ...
                               Expanded(
                                   ...
                                   child: Expanded(
                                     child: Column(
                                       crossAxisAlignment: CrossAxisAlignment.start,
                                       children: [
                                       Text('Certificate must show',
                                       style: TextStyle(
                                         fontSize: 15,
                                         color: Colors.grey[800],
                                       ),),
                                       Padding(
                                         padding: const EdgeInsets.fromLTRB(10.0,2,5,1),
                                       ...
                                       style: TextStyle(
                                         ...
                                         Padding(
                                         padding: const EdgeInsets.fromLTRB(8.0,2,5,1),
                                            ...
                                            child: RaisedButton(
                                              color: Colors.blue,
                                               child: Text('Upload GST'),
                                                 onPressed: () {
                                       Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => UploadGSTDocument()));
                                                },
                                       ),
                                          ),
                                     ],),
