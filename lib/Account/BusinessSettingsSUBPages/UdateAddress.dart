           ...
           SizedBox(height: 15,),
            ...
            Container(
             ...
             child: ListTile(
                            ...
                            title: Text('Contact Person Name',
                            style: TextStyle(
                              fontSize: 12
                            ),),
                            subtitle: TextField(
                   ...
                   GestureDetector(
                     onTap: (){
                       ...
                       children: [
                         ...
                         Expanded(
                                                      child: Text('  (Change Contact mobile number)',
                           style: TextStyle(fontSize: 12,
                           color: Colors.blue),),
                         )
                       ],
                            ...
                            //  child: 
                             Align(
                               alignment: Alignment.topLeft,
                                    child: Text('Shop no. with Complex / Bazaar name',
                               style: TextStyle(fontSize: 12),),
                             ),
                          //  ),
                           Expanded(
                         ...
                         children: [
                          ...
                          //    padding: const EdgeInsets.only(right:45.0),
                            //  child: 
                             Align(
                               alignment: Alignment.topLeft,
                                    child: Text("Address (Street and Area) ",
                               style: TextStyle(fontSize: 12),),
                             ),
                          //  ),
                           Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("Please enter a new mobile number",
              style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15),),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("We will send  a 6-digit Verification Code to verify this number",
              style: TextStyle(fontSize: 12),),
            ),
            ListTile(
              leading: Text('+91'),
