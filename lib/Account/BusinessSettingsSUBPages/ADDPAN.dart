  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     child: Padding(
       ...
       child: Text('*individual PAN in case of proprietorship; entity PAN for others ',
                 ...
                 child: SingleChildScrollView(
                       ...
                       children: [
                        ...
                        padding: const EdgeInsets.fromLTRB(15,5,15,0),
                         ...
                         Padding(
                           padding: const EdgeInsets.all(15.0),
                           child: Text('Note : PAN CARD uploaded should be linked to gstin',
                             style: TextStyle(color: Colors.grey[600],
                             fontSize: 12),),
                         ),
                         Row(
                               ...
                               child: GestureDetector(
                                 onTap: (){
                                     Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Sample(
                                       image: 'assets/account/pancard.jpg',
                                     )));
                                 },
                                                  child: Image(
                    height: 120,
                    width: 120,
                    image: AssetImage("assets/account/pancard.jpg"),
                                      ...
                                      child: RaisedButton(
                                        color: Colors.blue,
                                         child: Text('Upload PAN'),
                                           onPressed: () {
                                 Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => UploadPANDocument()));
                                          },
                                 ),
                                    ),
                               ],),
