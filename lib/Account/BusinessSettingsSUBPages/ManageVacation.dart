                                    ...
                                    GestureDetector(
                                        onTap: () =>_selectDate(context),
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                        '$formattedDate', style: TextStyle(fontSize: 14),),
                                        // Image(
                                        //   height: 30,
                                        //    width: 30,
                 ...
                 child: Padding(
                   ...
                   child: Column(
                     ...
                     ListTile(
                       ...
                       style: TextStyle(fontWeight: FontWeight.bold,
                       fontSize: 18),),
                       title: Text("To create a new vacation , select 'Start Date' and click save",
                         style: TextStyle(
                       fontSize: 12,
                     ...
                     ListTile(
                       ...
                       style: TextStyle(fontWeight: FontWeight.bold,
                       fontSize: 18),),
                       title: Text("To modify a  vacation , update date(s)  and click save",
                         style: TextStyle(
                       fontSize: 12,
                       color: Colors.grey[600]), ),
                     ),
                     ...
                     ListTile(
                       ...
                       style: TextStyle(fontWeight: FontWeight.bold,
                       fontSize: 18),),
                       title: Text("Maximum allowed duration for setting vacation is 30 days",
                         style: TextStyle(
                       fontSize: 12,
                       color: Colors.grey[600]), ),
                     ),
                     ...
                     ListTile(
                       ...
                       style: TextStyle(fontWeight: FontWeight.bold,
                       fontSize: 18),),
                       title: Text("You are allowed to set vacation for a maximum of 40 days in a 6 month period (each half of the year). Which is 80 days in a year",
                         style: TextStyle(
                       fontSize: 12,
                       color: Colors.grey[600]), ),
                     ),
