          ...
          children: [
            SizedBox(height:25),
              Padding(
                ...
                child: Text("Want to see prices and start buying on Udaan?",
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text('Udaan is open OLD to Shop Owners and NOT to customers.',
                    style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left:15.0),
                child: Text('How to complete shop KYC ?',
                ...
                leading: Image(
                 ...
                 width: 20,
                  image: AssetImage("assets/account/dot.jpg"),
                   ...
                   title:   Text('Upload any ONE shop related document.',
                   style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 13,
                  ),),
