    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.redAccent,
          title: Text('Manage Media Gallery',
           ...
           Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text('A rich profile with good quality photos & videos can create lasting impact on Udaan users!',
                    style: TextStyle(
                      fontWeight: FontWeight.bold
                    ),),
                  ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Add photos of awards,certificates your business recieved.',
                    style: TextStyle(
                      fontWeight: FontWeight.bold
                    ),),
                  ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('Add photos of your retail shop,show varierty of products availabe in your shop.',
                    style: TextStyle(
                      fontWeight: FontWeight.bold
                    ),),
                  ),
