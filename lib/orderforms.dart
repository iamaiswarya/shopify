      ...
      appBar: AppBar( leading: IconButton(
          ...
          onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Navbar()));
              ...
              elevation: 0,
        title:
         Text('Order Forms',style: TextStyle(color: Colors.white),),
     ),
     ...
     body: Column(
       children: <Widget>[
         ...
         Container(
           ...
           child: Text('Oops! Looks like you have not added anything to your cart yet.',
           style: TextStyle(fontSize: 15,color: Colors.grey,),),
         ),
         Container(
          child: RaisedButton(
          onPressed: () {Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Navbar()));},
