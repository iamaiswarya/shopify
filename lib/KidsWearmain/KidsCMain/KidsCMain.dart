...
class KidsCMain extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red[600],
        title: Text('Kids camisole',
        style: TextStyle(
          color:Colors.white,
        ),),
                            ...
                            MaterialPageRoute(
                                builder: (BuildContext context) => Common(
                                   heading: 'Kids Camisole',
                                            ...
                                            image1:
                                                "assets/homecloth/kids/kidssub/ca1.jpg",
                                            image2:
                                                "assets/homecloth/kids/kidssub/ca2.jpg",
                                            image3:
                                                "assets/homecloth/kids/kidssub/ca3.jpg",
                                            image4:
                                                "assets/homecloth/kids/kidssub/ca1.jpg",
                                            image5:
                                                "assets/homecloth/kids/kidssub/ca2.jpg",
