...
import 'package:udaan/KidsWear/KidsWearsub/KidsBSub.dart';
...
class KidsBMain extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Kids Bloomer',
        style: TextStyle(
          color:Colors.black,
        ),),
                ...
                children:<Widget> [
                  customButton(onPressed: ()=>{
                   Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => KidsBSub()))
                  })
                ],
              ),
            ),
