...
import 'package:udaan/KidsWear/KidsWearsub/KidsNightSub.dart';
...
class KidsNightMain extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Kids night wear',
        style: TextStyle(
          color:Colors.black,
        ),),
                ...
                children:<Widget> [
                  customButton(onPressed: ()=>{
                   Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => KidsNightSub()))
                  })
                ],
              ),
            ),
