...
import 'package:udaan/KidsWear/KidsWearsub/KidsSocksSub.dart';
...
class KidsSocksMain extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Kids Soacks',
        style: TextStyle(
          color:Colors.black,
        ),),
                ...
                children:<Widget> [
                  customButton(onPressed: ()=>{
                   Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => KidsSocksSub()))
                  })
                ],
              ),
            ),
