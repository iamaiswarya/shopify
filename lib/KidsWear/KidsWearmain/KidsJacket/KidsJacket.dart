...
import 'package:udaan/KidsWear/KidsWearSub/KidsSweaterSub.dart';
import 'package:udaan/KidsWear/KidsWearSub/KidsJacketSub.dart';
...
class KidsJacket extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Kids Jacket',
        style: TextStyle(
          color:Colors.black,
        ),),
                ...
                children:<Widget> [
                  customButton(onPressed: (){
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => KidsJacketSub()));
                  })
                ],
              ),
            ),
