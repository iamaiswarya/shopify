...
import 'package:udaan/KidsWear/KidsWearsub/KidsThermalSub.dart';
import 'package:udaan/Home/Clothing/kidswear.dart';
void main() {
  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    home: KidsThermalMain() ,
  ));
}

class KidsThermalMain extends StatelessWidget {
  @override
                ...
                children:<Widget> [
                  customButton(onPressed: ()=>{
                   Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => KidsThermalSub()))
                  })
                ],
              ),
            ),
