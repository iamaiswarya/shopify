...
class Connectioninvite extends StatelessWidget {
  ...
  decoration: InputDecoration(
       ...
       ListTile(onTap: (){
        ...
        leading: Icon(Icons.add_circle_outline_rounded,color: Colors.blue),
        title: Text('Invite by Mobile Number',style: TextStyle(color: Colors.blue,fontSize: 15,fontWeight: FontWeight.bold),),
        trailing: Icon(Icons.chevron_right),
      ),
     Container(
             padding: EdgeInsets.all(0.5),
  ...
  child: Column(
    children: <Widget>[
      ...
      Text("Phone Number",
        ...
        fontSize: 17,),),
      SizedBox(height: 10),
      Padding(padding: EdgeInsets.only(top: 10, bottom: 10, right: 15, left: 15),
        ...
        children: <Widget>[
          RaisedButton(color: Colors.white,
            ...
            child: Text(
              "Cancel",
              style: TextStyle(
                color: Colors.black,fontFamily: 'chilanka',
              ),
            ),
          ),
          SizedBox(width: 8),
          RaisedButton(
            ...
            child: Text(
              "Send Invite",
              style: TextStyle(
                color: Colors.white,fontFamily: 'chilanka'
              ),
            ),
            onPressed: () {
              Navigator.of(context).pop();
