  ...
  child: Material(
    ...
    child: Center(
      child: InkWell(
        ...
        child: SizedBox(width: 20, height: 20, child: Icon(Icons.check,color: Colors.red[200]),),
        onTap: () {},
      ),
    ),
  ),
            ...
            child: Padding(
              ...
              child: Column(
               crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                Text("Brand in deals in",style: TextStyle(color:Colors.grey[600],fontSize: 12),),
                Row(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Text("Men Sweatshirt",style: TextStyle(color: Colors.blue),)),
                                )),
                              ),
                            ),
                            Expanded(
                                ...
                                child: Center(child: Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Text("Womens Short/HotPant",style: TextStyle(color: Colors.blue),)),
                                )),
                              ),
                                                        ),
                            )
                          ...
                          child: Container(
                                  ...
                                  child: Center(child: Padding(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Text("Womens T-Shirt",style: TextStyle(color: Colors.blue),)),
                                  )),
                                ),
                        ),
              ],),
