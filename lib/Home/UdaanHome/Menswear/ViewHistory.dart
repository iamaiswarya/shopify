  ...
  Widget build(BuildContext context) {
   return new Scaffold(
        appBar: new AppBar(
          ...
          title: Text('Fashion Qubes',style: TextStyle(color: Colors.white,fontSize: 15),),
          subtitle: Text("Tirupur, Tamil Nadu",style: TextStyle(color: Colors.white,fontSize: 12),),
        ),
