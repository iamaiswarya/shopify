  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: [
            ...
            Expanded(
                ...
                children: [
                  ...
                  SizedBox(height: 4,),
                  Text('Tirupur,Tamil Nadu',style: TextStyle(color: Colors.white,fontSize: 11,),)
                ],
      ),
            ),
          ],
            ...
            //   ),
              Container(
                ...
                child: Padding(
                  ...
                  child: Text('Tom Hiddle Cotton Round Neck Men Graphic Print\nT-shirt',
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => CompleteShopKYC()));
              ...
              GestureDetector(
                onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FashionUdaan()));  
                },
                              child: Padding(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              SizedBox(width: 5),
                              Text('Tom Hiddle',style: TextStyle(
                         ...
                         Row(
                                children: [
                                    ...
                                    Image.asset('assets/account/FromTheBrand.jpg',
                                      height: 50,
                                      width:90,),
                                  ...
                                  // fontSize: 14,fontWeight: FontWeight.bold),),
                                  // SizedBox(width: 5),
                                  Icon(Icons.arrow_forward_ios_sharp,color: Colors.grey,size: 14,)
                                ],
                              ),
                          ...
                          Container(
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#MenT-Shirt",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
                          Container(
                            height: 35,
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#Tom Hiddle",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
                          Container(
                            height: 35,
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#CLTWWB20",style: TextStyle(color: Colors.blue),)),
                            )),
                          )
                        ],
                      ),
...
class TableFashion extends StatelessWidget {
  ...
  TableFashion({Key key,this.flag, this.neck, this.clothingDesign, this.sleeve,this.idealFor,this.fabric, this.countryofOrigin,this.gsm,this.size, this.color}): super(key: key);
                      ...
                      children: [
                         TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Ideal For",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text(idealFor,textScaleFactor: 1.5,
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Neck",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Clothing Design/Style",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),

                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text(clothingDesign,textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Sleeve",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Fabric",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Country of Origin",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                                                          child: Container(
                                        color: Colors.indigo,
                                        child: Text(countryofOrigin,textScaleFactor: 1.5,
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Size",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
