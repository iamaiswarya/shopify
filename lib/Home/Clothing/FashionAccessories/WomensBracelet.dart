...
class WomensBracelet extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('Womens Bracelet ',
        style: TextStyle(
          color:Colors.black,
        ),),
                ...
                Card(
                    ...
                    color: Colors.white,
                                      child: Padding(
                                        ...
                                        child: ListTile(
                      leading:   Image(image: AssetImage('assets/FashionAccessories/WomenBracelet.jpg'),
                         height: 90,
                          width: 60,),
                ...
                children:<Widget> [
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left:15.0),
                        child: Text('Women Bracelets Type',
                        style: TextStyle(
