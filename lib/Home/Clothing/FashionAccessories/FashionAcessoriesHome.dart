                    ...
                    child: ListView(
                      ...
                      children: [
                        MyImage('assets/FashionAccessories/Cap1.jpg',
                            'Cap and Hat'),
                        MyImage('assets/FashionAccessories/Watch.jpg', 'Watch'),
                        MyImage('assets/FashionAccessories/WomenBracelet.jpg',
                            'Women Bracelet'),
                        MyImage('assets/FashionAccessories/MenBroach.jpg',
                            'Men Broch'),
            ...
            Container(
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading: Image(
                      image: AssetImage('assets/FashionAccessories/Watch.jpg'),
                    ),
                    title: Text('Watches',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  ListTile(
                    leading: Image(
                      image: AssetImage('assets/FashionAccessories/Belts.jpg'),
                    ),
                    title: Text('Belts',
                        style: TextStyle(fontWeight: FontWeight.bold)),
                    trailing: Icon(Icons.chevron_right),
