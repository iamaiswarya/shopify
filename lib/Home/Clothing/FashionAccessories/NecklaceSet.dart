...
class NecklaceSet extends StatelessWidget {
  @override
                ...
                Card(
                    ...
                    color: Colors.white,
                                      child: Padding(
                                        ...
                                        child: ListTile(
                      leading:   Image(image: AssetImage('assets/FashionAccessories/FashionJewellery.jpg'),
                         height: 90,
                          width: 60,),
                    ...
                    children: [
                      Container(
                       ...
                       Container(
                        ...
                        height: MediaQuery.of(context).size.height*0.2,
                        child: FlatButton(onPressed: (){}, 
                        child: Image.asset('assets/FashionAccessories/Brand3.jpg'),
                        ),
                      ),
                       Container(
                        // color: Colors.white,
                        ...
                        height: MediaQuery.of(context).size.height*0.2,
                        child: FlatButton(onPressed: (){}, 
                        child: Image.asset('assets/FashionAccessories/Brand2.jpg'),
                        ),
                      ),
