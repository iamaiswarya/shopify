...
class SchoolBag extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text('School Bags',
        style: TextStyle(
          color:Colors.black,
        ),),
                  ...
                  Card(
                    ...
                    color: Colors.white,
                                      child: Padding(
                                        ...
                                        child: ListTile(
                      leading:   Image(image: AssetImage('assets/FashionAccessories/Schoolbag.jpg'),
                         height: 90,
                          width: 60,),
                          title: Text("1870 Listing"),
