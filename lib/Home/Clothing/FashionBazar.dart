          ...
          image: new DecorationImage(
            ...
            Expanded(
                ...
                children: [
                  ...
                  SizedBox(height: 4,),
                  Text('Rajkot,Gujarat',style: TextStyle(color: Colors.white,fontSize: 11,),)
                ],
      ),
            ),
          ],
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              MenswearCard(
               img: ("assets/FashionBazar/Earring.jpg"),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text('Fashion Bazar',style: TextStyle(
                         ...
                         Row(
                                children: [
                                    ...
                                    Image.asset('assets/FashionBazar/FashionBazar.jpg',
                                      height: 50,
                                      width:90,),
                      ...
                      children: [
                         TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Stone Type",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Dangle & Drop Earring",textScaleFactor: 1.5,
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Theme",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Beads",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Plating",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),

                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Antiue",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Occasion",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Daily",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Base Metal",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Brass",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        TableRow(
                            children: [
                              Padding(
                                ...
                                Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Free Size",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                          ...
                          Container(
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#WomenEarring",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
                          Container(
                            height: 35,
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#National",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
                          Container(
                            height: 35,
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#CLTNYWB21",style: TextStyle(color: Colors.blue),)),
                            )),
                          )
                        ],
                      ),
          ...
          height: 260,
            ...
            child: Wrap(
              children: [GestureDetector(
                onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FashionBazar()));    
                },
                          child: Center(
