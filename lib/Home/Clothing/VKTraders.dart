...
class VKTraders extends StatefulWidget {
  @override
  _VKTradersState createState() => _VKTradersState();
}
String text =
...
class _VKTradersState extends State<VKTraders> {
          ...
          image: new DecorationImage(
            ...
            Expanded(
                ...
                children: [
                  ...
                  SizedBox(height: 4,),
                  Text('Delhi,Delhi',style: TextStyle(color: Colors.white,fontSize: 11,),)
                ],
      ),
            ),
          ],
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              MenswearCard(
               img: ("assets/VKTraders/HomeCurtains.jpg"),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text('VK Traders',style: TextStyle(
                         ...
                         Row(
                                children: [
                                    ...
                                    Image.asset('assets/VKTraders/VK.jpg',
                                      height: 50,
                                      width:90,),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                            "Offer: Get 2% discount on minimum purchase of ₹ 15,000.00.",
                            style: TextStyle(
                      ...
                      children: [
                         TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("PVC",textScaleFactor: 1.5,
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Fabric Type",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                        ...
                        TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Kitchen roll 18 inch width 10 mtr length",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                        ...
                        TableRow(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Length",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10),),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                        ...
                        TableRow(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text("Print",textScaleFactor: 1.5,
                                  style: TextStyle(fontSize: 10,color: Colors.blue),),
                              ),
                            ]
                        ),
                          ...
                          Container(
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#HomeFurnishingFabric",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
                          SizedBox(width: 20,),
                          Container(
                            ...
                            child: Center(child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("#V K Traders",style: TextStyle(color: Colors.blue),)),
                            )),
                          ),
          ...
          height: 260,
            ...
            child: Wrap(
              children: [GestureDetector(
                onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => VKTraders()));    
                },
                          child: Center(
