        ...
        title: RichText(
          text:TextSpan(
            ...
            children: [
              ...
              TextSpan(text:'  Reverse Shipment policy',
                style:TextStyle(
                    color: Colors.white,
                    fontSize: 22,
          ...
          child :Column(
            children: [
              RichText(text: TextSpan(
                text:'Last Updated on 5th December 2020\n\nApplicable from 10th september 2019',
                style:TextStyle(
                  fontSize:16,
                   color: Colors.black,
              ...
              TextSpan(
                text:'safety.Youalso get: our promise of simplifying complex insurance terms and conditions, quick stress-free claims, instant quotes from top insurers and being present for you in the toughest of times.',
                style:TextStyle(
                  fontSize:18.0,
                ),
              ),
