        ...
        // height: 65,
              ...
              leading: ClipRect(
                            ...
                            title:  Padding(
                              ...
                              child: Text('Clothing & Acessories', style: TextStyle(
                                fontFamily: 'Chilanka',
                                fontWeight: FontWeight.bold),),
                               ),
                              subtitle: new Text("Women's ethic , Women's Western , Men's Garments and Kid's Wears",
                              style: TextStyle(
                                fontSize: 12,
                              // fontFamily: 'Chilanka',
                              ),),
   ...
   SizedBox(
        ...
        // onTap: () => eitherRadioTapped(),
          ...
          child: new ListTile(
                    ...
                    title:  Padding(
                      padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                      child: Text('Electronics & Appliance', style: TextStyle(
                        fontFamily: 'Chilanka',
                        fontWeight: FontWeight.bold),),
                    ),
                      subtitle: new Text("Mobile and Electronics , IT & Computers , COVID Essentials",
                      style: TextStyle(
                        fontSize: 12,
                      // fontFamily: 'Chilanka',
                      ),),
    ...
    child: new ListTile(
                ...
                title:  Padding(
                  padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                  child: Text('Home & Kitchen', style: TextStyle(
                    fontFamily: 'Chilanka',
                    fontWeight: FontWeight.bold),),
                ),
                  subtitle: new Text("Steel Aluminium Copper Utensils Appliance , Kitchen Appliance ",
                  style: TextStyle(
                    fontSize: 12,
                  // fontFamily: 'Chilanka',
                  ),),
    ...
    child: new ListTile(
                ...
                title:  Padding(
                  padding: const EdgeInsets.fromLTRB(0, 5, 0, 5),
                  child: Text('OpenBox & Used', style: TextStyle(
                    fontFamily: 'Chilanka',
                    fontWeight: FontWeight.bold),),
                ),
                  subtitle: new Text("OpenBox & Used",
                  style: TextStyle(
                    fontSize: 12,
                  // fontFamily: 'Chilanka',
                  ),),
    ...
    child: new ListTile(
                ...
                title:  Padding(
                  ...
                  subtitle: new Text("Lights & Light Accessories,Switch & Switch Accessories",
                  style: TextStyle(
                    fontSize: 12,
                  // fontFamily: 'Chilanka',
                  ),),
