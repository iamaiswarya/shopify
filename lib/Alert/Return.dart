  ...
  child:   Container(
    ...
    child:   Column(
      mainAxisAlignment: MainAxisAlignment.center,
              ...
              SizedBox(height: 15,),
              Text('No results found',style: TextStyle(fontSize:15,),),
               SizedBox(height: 15,),
              Text('View your delivered shipments',style: TextStyle(fontSize:11,color: Colors.grey[600]),),
               SizedBox(height: 15,),
                 Center(
            child: FlatButton(
            color: Colors.blue,
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Order()));  
            },
