      ...
      SingleChildScrollView(
        child:ConstrainedBox(constraints: BoxConstraints(),
          ...
          children: [
            ...
            Container(
              child: Text(
                "Register you bussiness on Udaan.",
             ...
             Container(
                     ...
                     Container(
                      ...
                      decoration: InputDecoration(
                          ...
                          filled: true,
                          prefixIcon: Icon(Icons.backpack,color: Colors.red,),
                          fillColor: Colors.white,
                          hintStyle: TextStyle(color: Color(0xFF666666),fontSize: 15),
                     ...
                     Container(
                      padding: EdgeInsets.fromLTRB(20,5,20,5),
                      child: TextField(showCursor: true,keyboardType: TextInputType.number,
                      decoration: InputDecoration(
                          border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(1)),
                          ),
                          filled: true,
                    ...
                    CheckboxListTile(
    title: Text("Recieve order and account related updates on WhatsApp",style: TextStyle(fontSize: 14,color: Colors.grey[500]),),
    value: checkedValue,
